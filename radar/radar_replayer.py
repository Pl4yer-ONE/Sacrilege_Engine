...
class RadarReplayer:
    ...
    def _update(self):
        ...
        # Recalculate round kills fresh each update (for seeking support)
        self.round_kills = {'CT': 0, 'T': 0}
        
        # Process kills in this round up to current tick
